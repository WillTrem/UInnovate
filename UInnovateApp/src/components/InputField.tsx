...
import { Switch, Select, createTheme } from "@mui/material";
import {
...
const InputField: FC<InputFieldProps> = ({
  ...
  if (
    ...
    return (
      <Switch
        checked={
          currentRow?.row[column.column_name] == "true" ? true : false || false
        }
        name={column.column_name}
      />
    );
    ...
    return (
      <Select
        value={
          currentCategory ? currentCategory : currentRow.row[column.column_name]
        }
        name={column.column_name}
        onChange={(event) => {
