...
-- ticket statuses
INSERT INTO application.ticket_status (status_name) VALUES
    ('Open'),
    ('InProgress'),
    ('AwaitingResponse'),
    ('Closed'),
...
INSERT INTO application.ticket_tags (tag_name) VALUES
    ('UI'),
    ('Frontend'),
    ('Backend'),
    ('Database'),
...
INSERT INTO application.service_ticket_tags (ticket_id, tag_id) VALUES
    (1, 1),
    (1, 2),
    (2, 3),
    (2, 5),
